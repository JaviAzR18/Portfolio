...
=================================================== */
  ...
  return (
    <main>
      ...
      {/* ===== Mobile Nav Overlay ===== */}
      <div className="nav-mobile-overlay" id="mobileNav" role="navigation" aria-label="Mobile Navigation">
      ...
      <nav id="navbar" role="navigation" aria-label="Main Navigation">
        <ul className="nav-links">
          ...
          <li>
            <div className="theme-select" id="themeSelect">
              <button className="theme-select-trigger" id="themeSelectTrigger" aria-label="Select Theme" title="Switch Theme">
                <svg className="theme-icon" width="20" height="20" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor"
                  fill="none" strokeLinecap="round" strokeLinejoin="round">
                  {/* Active icon will be injected by JS */}
                </svg>
              </button>
              <div className="theme-options" id="themeOptions">
                <button className="theme-option" data-theme-value="light" title="Light Mode">
                  <svg width="18" height="18" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none"
                ...
                <button className="theme-option" data-theme-value="dark" title="Dark Mode">
                  <svg width="18" height="18" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none"
                    strokeLinecap="round" strokeLinejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <button className="theme-option" data-theme-value="system" title="System Preference">
                  <svg width="18" height="18" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none"
                    strokeLinecap="round" strokeLinejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
      ...
      <section id="hero" aria-label="Hero">
        ...
        <div className="hero-content">
          <div className="hero-badge">
            ...
            <a href="https://linkedin.com/in/javier-aznar-ruiz" target="_blank" rel="noopener noreferrer"
              className="hero-badge-link">
              Available for opportunities
            </a>
          </div>
          <h1 className="hero-name">
            Javier<br /><span className="gradient-text">Aznar Ruiz</span>
          </h1>
          <p className="hero-title">
            <span style={{ color: 'white' }}>Data Analyst</span> &amp; <span>ML Engineer</span>
          </p>
          <p className="hero-description">
            3+ years of experience across software development, now moving into data engineering and machine learning
            — Valencia, Spain.
          </p>
          <div className="hero-cta">
            ...
            <a href="https://linkedin.com/in/javier-aznar-ruiz" className="contact-link linkedin" id="contact-linkedin-link"
              target="_blank" rel="noopener noreferrer">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path
                  d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2zm2-4a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" />
              </svg>
              LinkedIn
            </a>
          </div>
        ...
        <div className="container">
          <div className="section-title reveal">
            ...
            <h2 className="section-heading">
              <svg className="size-8" width="40" height="40" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor"
                fill="none" strokeLinecap="round" strokeLinejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
          ...
          <div className="about-grid">
            ...
            <div className="about-photo-col reveal">
              <div className="about-photo-wrapper">
                <img src="/photo.webp" alt="Javier Aznar Ruiz" className="about-photo" />
            ...
            <div className="about-text reveal reveal-delay-1">
              <p>
                I'm a <strong>Data Analyst & ML Engineer</strong> with over 3 years of professional experience in software
                development. My journey began in video game development with Unity and C#, which gave me a strong
                engineering foundation.
              </p>
              <p>
                Over time, I expanded into <strong>web application development</strong> (frontend and backend) and
                pivoted toward data engineering and machine learning. I recently completed an
                <strong>Executive Master's in Big Data and Artificial Intelligence</strong>.
              </p>
              <p>
                I'm experienced with <strong>Python, SQL, PySpark, BigQuery</strong> and <strong>Power BI</strong>, with
                hands-on projects in predictive modelling and data-driven applications. I'm eager to apply these
                analytical skills in consulting environments, helping clients transform data into decisions.
              </p>
              <div className="contact-info" style={{ marginTop: '1.5rem' }}>
                <div className="contact-item" id="about-email-link" onClick={() => { copyEmail() }}>
                  <div className="icon">✉</div>
                  javieraznarruiz@gmail.com
                </div>
                <a href="https://linkedin.com/in/javier-aznar-ruiz" className="contact-item" id="about-linkedin-link"
                  target="_blank" rel="noopener noreferrer">
                  <div className="icon">in</div>
                  linkedin.com/in/javier-aznar-ruiz
                </a>
                <div className="contact-item" id="about-phone-link" onClick={() => { copyPhone() }}>
                  <div className="icon">📞</div>
                  +34 634 93 18 07
                </div>
      ...
      <section id="experience" aria-label="Experience">
        <div className="container">
          <div className="section-title reveal">
            ...
            <h2 className="section-heading"><svg className="size-8" width="40" height="40" viewBox="0 0 24 24" strokeWidth="2"
            ...
            </svg> Work <span className="gradient-text">Experience</span></h2>
          </div>
            ...
            <div className="timeline-item reveal">
              ...
              <div className="timeline-card">
                <div className="timeline-meta">
                  <span className="timeline-company">FuntechRocket</span>
                  <span className="timeline-date">Mar 2022 – Nov 2025</span>
                </div>
                <div className="timeline-role"><strong>Software Developer</strong></div>
                <ul className="timeline-list">
                  <li>Developed a unified enhancement of components and scripts to technically converge the company's
                    product delivery pipeline and accelerate release cycles.</li>
                  <li>Contributed an innovative new engine for executing a flexible programming environment based on actors
                    and events-driven architecture.</li>
                  <li>Implemented CI/CD practices improving software delivery efficiency — reducing deployment times by over
                    60% and minimizing production errors.
                  </li>
                  <li>Built in-house tooling for sending and receiving messages from users within the platform.</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="timeline">
            <div className="timeline-item reveal">
              ...
              <div className="timeline-card">
                <div className="timeline-meta">
                  <span className="timeline-company" style={{ color: 'var(--accent-purple)' }}>Intecssa – Inertia Institute</span>
                  <span className="timeline-date">Oct 2024 – Mar 2026</span>
                </div>
                <div className="timeline-role">Executive Master's in Big Data &amp; Artificial Intelligence · Online</div>
                <ul className="timeline-list">
                  <li>Advanced ML models: regression, classification, clustering, and neural networks.</li>
                  <li>Big Data technologies: PySpark, cloud data pipelines on AWS, Azure &amp; GCP.</li>
                  <li>Applied projects in natural language processing and computer vision.</li>
                </ul>
              </div>
            </div>
            ...
            <div className="timeline-item reveal reveal-delay-2">
              ...
              <div className="timeline-card">
                <div className="timeline-meta">
                  <span className="timeline-company" style={{ color: 'var(--accent-purple)' }}>Universidad Politécnica de
                    Valencia</span>
                  <span className="timeline-date">Graduated May 2022</span>
                </div>
                <div className="timeline-role">Bachelor's Degree in Telecommunications Technologies &amp; Services · Valencia,
                  Spain</div>
                <ul className="timeline-list">
                  <li>Solid foundation in signal processing, networks, and software engineering principles.</li>
                  <li>
                    <span>
                      <strong>Final thesis: Augmented Reality Application for Teaching Faraday-Lenz's Law</strong>
                      <span style={{ display: 'block', marginTop: '0.5rem', opacity: '0.9', lineHeight: '1.6' }}>
                        I developed an Android mobile application based on Augmented Reality aimed at educational use in the
                        Physics laboratory of ETSIT (Universitat Politècnica de València). The project's goal is to
                        facilitate
                        the understanding of the electromagnetic induction phenomenon through an interactive and immersive
                        experience accessible from any smartphone.
                      </span>
                    </span>
                  </li>
                </ul>
          ...
          <div className="skills-grid">
              ...
              <div className="skill-tags">
                <span className="skill-tag">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="16 16 32 32">
                    ...
                    <defs>
                      <linearGradient id="python__a" x1="19.075" x2="34.898" y1="18.782" y2="34.658"
                        gradientUnits="userSpaceOnUse">
                        <stop stop-color="#387EB8" />
                        <stop offset="1" stop-color="#366994" />
                      </linearGradient>
                      <linearGradient id="python__b" x1="28.809" x2="45.803" y1="28.882" y2="45.163"
                        gradientUnits="userSpaceOnUse">
                ...
                <span className="skill-tag">
                  <svg width="800px" height="800px" viewBox="-8.78 0 70 70" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      fill="currentColor" transform="translate(-830.906 -943.981)" />
                  </svg>
                  SQL
                </span>
                <span className="skill-tag">
                  <svg xmlns="http://www.w3.org/2000/svg" width="2222" height="2500" preserveAspectRatio="xMidYMid"
            ...
            <div className="skill-category reveal reveal-delay-2">
              ...
              <div className="skill-tags">
                ...
                <span className="skill-tag">
                  <svg xmlns="http://www.w3.org/2000/svg" width="256" height="256" viewBox="0 0 256 256">
                    <g fill="#AFDAD2" stroke="#FFF" strokeWidth=".25">
                      ...
                      <path
                        d="M174.151 30.958a4.25 4.25 0 1 0 0-8.501a4.25 4.25 0 0 0 0 8.5Zm-92.824-4.532a3.405 3.405 0 1 0 0-6.81a3.405 3.405 0 0 0 0 6.81Zm8.176-2.632a3.756 3.756 0 1 0 0-7.513a3.756 3.756 0 0 0 0 7.513Zm57.896-4.708a4.407 4.407 0 1 0 0-8.814a4.407 4.407 0 0 0 0 8.814Zm-17.707.934a3.43 3.43 0 1 0 0-6.86a3.43 3.43 0 0 0 0 6.86Zm26.508 4.186a2.623 2.623 0 1 0 0-5.246a2.623 2.623 0 0 0 0 5.246Z" />
                      <path
                        d="M147.442 28.232a4.864 4.864 0 1 0 0-9.727a4.864 4.864 0 0 0 0 9.727Zm19.303-4.719a3.361 3.361 0 1 0 0-6.723a3.361 3.361 0 0 0 0 6.723ZM15.926 105.501a4.222 4.222 0 1 0 0-8.444a4.222 4.222 0 0 0 0 8.444Zm95.796-82.278a2.273 2.273 0 1 0 0-4.546a2.273 2.273 0 0 0 0 4.546ZM189.81 33.63a2.743 2.743 0 1 0 0-5.487a2.743 2.743 0 0 0 0 5.486Zm-51.268-13.723a3.967 3.967 0 1 0 0-7.934a3.967 3.967 0 0 0 0 7.934ZM47.95 80.147a4.57 4.57 0 1 0 0-9.142a4.57 4.57 0 0 0 0 9.142Z" />
                    </g>
                  </svg>
                  Seaborn
                </span>
                ...
                <span className="skill-tag">
                  <svg version="1.1" viewBox="0 0 6.3499999 6.3499999" height="6.3499999mm" width="6.3499999mm"
                    xmlns="http://www.w3.org/2000/svg">
                    <path style={{ fill: 'currentColor', fillOpacity: '0.98', stroke: 'none' }}
            ...
            <div className="skill-category reveal reveal-delay-3">
              ...
              <div className="skill-tags">
                ...
                <span className="skill-tag">
                  <svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" viewBox="0 0 432.071 445.383">
                    <g
                      style={{ fillRule: 'nonzero', clipRule: 'nonzero', fill: 'none', stroke: '#fff', strokeWidth: '12.4651', strokeLinecap: 'round', strokeLinejoin: 'round', strokeMiterlimit: '4' }}>
                      <path
                ...
                <span className="skill-tag">
                  <svg width="800px" height="800px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <g data-name="Product Icons">
                      <g>
                        <path style={{ fill: '#aecbfa', fillRule: 'evenodd' }}
                          d="M6.73,10.83v2.63A4.91,4.91,0,0,0,8.44,15.2V10.83Z" />
                        <path style={{ fill: '#669df6', fillRule: 'evenodd' }}
                          d="M9.89,8.41v7.53A7.62,7.62,0,0,0,11,16,8,8,0,0,0,12,16V8.41Z" />
                        <path style={{ fill: '#aecbfa', fillRule: 'evenodd' }} d="M13.64,11.86v3.29a5,5,0,0,0,1.7-1.82V11.86Z" />
                        <path style={{ fill: '#4285f4', fillRule: 'evenodd' }}
            ...
            <div className="skill-category reveal reveal-delay-1">
              <div className="skill-category-header">
                <div className="skill-category-icon">
                  <svg width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none"
                    ...
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    <path
                      d="M6.657 18c-2.572 0 -4.657 -2.007 -4.657 -4.483c0 -2.475 2.085 -4.482 4.657 -4.482c.393 -1.762 1.794 -3.2 3.675 -3.773c1.88 -.572 3.956 -.193 5.344 1.045c1.4 .82 2.322 2.295 2.322 3.96c1.884 .227 3.333 1.845 3.333 3.765c0 2.074 -1.678 3.755 -3.75 3.75h-10.924z" />
                  </svg>
                </div>
              ...
              <div className="skill-tags">
                ...
                <span className="skill-tag">
                  <svg xmlns="http://www.w3.org/2000/svg" width="800" height="800" preserveAspectRatio="xMidYMid"
                ...
                <span className="skill-tag">
                  <svg width="800px" height="800px" viewBox="0 0 1200 1600" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <mask id="pbi_mask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="200" y="0" width="1000"
                      height="1600">
                      <path
                    ...
                    <g mask="url(#pbi_mask0)" transform="translate(-200)">
                      <path
                    ...
                    <defs>
                      <linearGradient id="pbi_paint0" x1="758.333" y1="0" x2="1447.82" y2="1507.15"
                        gradientUnits="userSpaceOnUse">
                        <stop stop-color="#E6AD10" />
                        <stop offset="1" stop-color="#C87E0E" />
                      </linearGradient>
                      <linearGradient id="pbi_paint1" x1="524.955" y1="400" x2="1105.79" y2="1561.67"
                        gradientUnits="userSpaceOnUse">
                        <stop stop-color="#F6D751" />
                        <stop offset="1" stop-color="#E6AD10" />
                      </linearGradient>
                      <linearGradient id="pbi_paint2" x1="199.955" y1="800" x2="519.784" y2="1581.68"
                        gradientUnits="userSpaceOnUse">
      ...
      <section id="projects" aria-label="Projects">
        <div className="container">
          ...
          {/* Carousel wrapper */}
          <div className="projects-carousel" id="projectsCarousel" aria-label="Projects carousel">
            <div className="carousel-track" id="carouselTrack">

              {/* Project 1 */}
              <div className="project-card" id="project-churn" role="group" aria-label="Project 1 of 4">
                <div className="project-image">
                  <img src="/projects/churn-prediction.png" alt="Customer Churn Prediction Dashboard" />
                </div>
                <div className="project-content">
                  ...
                  <p className="project-desc">
                    Full-stack web application predicting telecom customer churn. Applied EDA, feature engineering,
                    and hyperparameter tuning using a Naive Bayes classifier.
                  </p>
                  <div className="project-actions">
                    <a href="https://github.com/JaviAzR18/ChurnPrediction" className="project-btn btn-code" target="_blank">
                    ...
                    {/* <a href="#" className="project-btn btn-preview" target="_blank">
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              {/* Project 2 */}
              <div className="project-card" id="project-football" role="group" aria-label="Project 2 of 4">
                <div className="project-image">
                  <img src="/projects/laliga-goals.png" alt="LaLiga Goal Prediction Analysis" />
                </div>
                <div className="project-content">
                  <div className="project-header">
                    <h3 className="project-title">LaLiga Goal Prediction (xG)</h3>
                  </div>
                  <div className="project-tags">
                    <span className="project-tag">Python</span>
                    <span className="project-tag">Pandas</span>
                  ...
                  <p className="project-desc">
                    Web application predicting player goals using xG metrics and Poisson modeling.
                    Features interactive visualizations and goal probability distributions.
                  </p>
                  <div className="project-actions">
                    <a href="https://github.com/JaviAzR18/FantasyApp" className="project-btn btn-code" target="_blank">
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path
                          d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" />
                    ...
                    <a href="https://fantasy-app-sigma.vercel.app/" className="project-btn btn-preview" target="_blank">
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" />
                        <polyline points="15 3 21 3 21 9" />
              ...
              <div className="project-card" id="project-nlp" role="group" aria-label="Project 3 of 4">
                ...
                <div className="project-content">
                  <div className="project-header">
                    <h3 className="project-title">NLP Text Summarisation</h3>
                  </div>
                  <div className="project-tags">
                    <span className="project-tag">Python</span>
                    <span className="project-tag">Streamlit</span>
                    <span className="project-tag">NLP</span>
                    <span className="project-tag">ROUGE</span>
                  </div>
                  <p className="project-desc">
                    Extractive and abstractive text summarisation pipeline build with HuggingFace.
                    Evaluated using ROUGE metrics and visualised with Streamlit.
                  </p>
                  <div className="project-actions">
                    <a href="https://github.com/JaviAzR18/NLP_PDF_SUMMARIZER" className="project-btn btn-code" target="_blank">
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path
                          d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" />
              ...
              {/* Project 4 */}
              <div className="project-card" id="project-spark" role="group" aria-label="Project 4 of 4">
                <div className="project-image">
                  <img src="/projects/spark_project.png" alt="Big Data Pipeline Visualization" />
                </div>
                <div className="project-content">
                  <div className="project-header">
                    <h3 className="project-title">Big Data Pipeline with PySpark</h3>
                  </div>
                  <div className="project-tags">
                    <span className="project-tag">PySpark</span>
                    <span className="project-tag">BigQuery</span>
                    <span className="project-tag">GCP</span>
                    <span className="project-tag">Power BI</span>
                  </div>
                  <p className="project-desc">
                    End-to-end pipeline on GCP transforms large-scale datasets using PySpark and BigQuery.
                    Includes quality checks and Power BI dashboards.
                  </p>
                  <div className="project-actions">
                    <a href="#" className="project-btn btn-code" target="_blank">
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path
                          d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" />
          ...
          <div className="carousel-controls">
            <button className="carousel-btn" id="carouselPrev" aria-label="Previous project">
            ...
            <button className="carousel-btn" id="carouselNext" aria-label="Next project">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"
                aria-hidden="true">
        ...
        <div className="container">
          ...
          <div className="contact-wrapper reveal">
            <div className="contact-card">
              ...
              <p>
                Whether it's a full-time role, a consulting project, or just a conversation about data and AI —
                my inbox is always open. Let's turn your data challenges into solutions.
              </p>
              <div className="contact-links">
                <button className="contact-link email" id="contact-email-btn" onClick={() => { copyEmail() }}
                  ...
                  <span id="emailBtnText">Email Me</span>
                </button>
              </div>
              {/* Clipboard toast */}
              <div className="email-toast" id="emailToast" role="status" aria-live="polite">✓ Email copied to clipboard!</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ===== Footer ===== */}
      <footer>
        <p>Designed &amp; built by <span>Javier Aznar Ruiz</span> · 2026 · Valencia, Spain 🇪🇸</p>
      </footer>
