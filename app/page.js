      ...
      <div className="about-grid">
        ...
        <div className="about-photo-col reveal">
          <div className="about-photo-wrapper">
            <img src="public/photo.webp" alt="Javier Aznar Ruiz" className="about-photo" />
        ...
        <div className="carousel-track" id="carouselTrack">
          ...
          <div className="project-card" id="project-churn" role="group" aria-label="Project 1 of 4">
            <div className="project-image">
              <img src="public/projects/churn-prediction.png" alt="Customer Churn Prediction Dashboard" />
            </div>
          ...
          <div className="project-card" id="project-football" role="group" aria-label="Project 2 of 4">
            <div className="project-image">
              <img src="public/projects/laliga-goals.png" alt="LaLiga Goal Prediction Analysis" />
            </div>
            <div className="project-content">
              <div className="project-header">
          ...
          <div className="project-card" id="project-nlp" role="group" aria-label="Project 3 of 4">
            <div className="project-image">
              <img src="public/projects/nlp_project.png" alt="NLP Text Summarization Interface" />
            </div>
            <div className="project-content">
              <div className="project-header">
          ...
          <div className="project-card" id="project-spark" role="group" aria-label="Project 4 of 4">
            <div className="project-image">
              <img src="public/projects/spark_project.png" alt="Big Data Pipeline Visualization" />
            </div>
            <div className="project-content">
              <div className="project-header">
